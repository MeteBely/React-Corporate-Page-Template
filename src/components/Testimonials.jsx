    ...
    <section className="bg-[#F5F6F8]">
      <div className="py-24 m-auto">
        <div className="mb-20 px-2">
          <h2 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[52px] font-extrabold pb-4 mb-4 text-[#000] border-b border-gray-400 mx-auto text-center w-auto min-[500px]:w-[470px] md:w-[500px] fontMontserrat">
            TESTIMONIALS
          </h2>
